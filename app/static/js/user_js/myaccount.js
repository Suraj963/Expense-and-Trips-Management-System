...
function save_update_account(){
       ...
       let formData = new FormData(); 
         ...
         $.ajax({
            ...
            success:function(res){
              $('#name').val(res[0].us_name);
              $('#email').val(res[0].us_email_id);
              $('#mobile').val(res[0].us_mobile);
              $('#password').val(res[0].us_password);
              $("#userImage").attr("src", res[0].us_image);
            },
            error:function(err){
            },
            complete:function(){
